...
class FilterSpecies implements Tool
{
    ...
    private const ATTRIBUTES = [
        ...
        'use_group' => ['type' => 'json_bilingual', 'lao' => 'use_groups', 'en' => null],
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            ...
            'use_type' => $schema->string()->description('A specific use category. Valid values include: Food, Drink, Medicine, Cosmetic, Recreational drugs, Clothing, Construction, Ornamental, Tools and utensils, Cleaning supplies, Glues and lubricants, Energy and lighting, Farming activities, Transport, Colouring and dyes, Culture and religion, Leisure. English or Lao.'),
            'use_group' => $schema->string()->description('A top-level use GROUP: Human Body, Household, Community, or Prohibitions (each covers several use types). English or Lao.'),
